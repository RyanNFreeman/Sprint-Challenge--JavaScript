...
let fullName = [];
let contactInfo = graduates.forEach(function(i) {
  fullName.push(i.first_name + " " + i.email);
});
...
*/
const animalNames = [];
const names = zooAnimals.forEach(function (i) {
...
*/
const largerPopulation = zooAnimals.filter((small) => {
